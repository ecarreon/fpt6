...
<html>
	...
	<body>
		<?php
			...
			$resultado1=mysqli_query($conexion,"SELECT idUsuario FROM usuarios WHERE usuario='$usr' AND contrasena='$pwd'");
			...
			if($registro = mysqli_fetch_row($resultado))
			{
				...
				?>
				<div class="jumbotron">
					<h1 class="display-4">Bienvenido al sistema <?php echo strtoupper($registro[1]); ?></h1>
					<p class="lead">En esta página encontrarás lo necesario para...</p>
					<hr class="my-4">
				</div>
				<meta http-equiv="refresh" content="1;url=insertar.html"/>
			<?php
			}
